;(function ($) {
    ...
    const cursor = document.querySelector(".econo-js-cursor");
    let follower;
    let label;
    let drap;
    let icon;
    ...
    function variables() {
        ...
        follower = cursor.querySelector(".econo-js-follower");
        label = cursor.querySelector(".econo-js-label");
        drap = cursor.querySelector(".econo-js-drap");
        icon = cursor.querySelector(".econo-js-icon");
