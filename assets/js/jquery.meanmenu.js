	...
	"use strict";
		$.fn.meanmenu = function (options) {
				var defaults = {
						...
						meanMenuClose: "<i class=\"fi-close\"></i>", // single character you want to represent the close menu button
						meanMenuCloseSize: "26px", // set font size of close button
						meanMenuOpen: "<i class=\"fi-menu\"></i>", // text/markup you want when menu is closed
